...
```{r raster_plot, message=FALSE, warning=FALSE, out.height="600px", out.width="800px"}
...
bin100_msr_plot <-
  ...
  ggtitle(paste0(bin10_basenames[1], " mean spike rate (100-ms bins)")) +
  xlab("Time (sec)") +
...
## Here's the mean spike rate plot
bin100_msr_plot
```
