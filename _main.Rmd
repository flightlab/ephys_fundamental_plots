...
<!--chapter:end:02-spike_sorting.Rmd-->

# Raw data and spike sorted traces

Coming soon

<!--chapter:end:03-raw_data_spike_sorted_traces.Rmd-->
...
<!--chapter:end:05-raster_mean_spike_rate.Rmd-->
...
<!--chapter:end:06_polar_direction_tuning.Rmd-->

# Spatiotemporal tuning

Coming soon

<!--chapter:end:07_spatemp_tuning.Rmd-->
...
<!--chapter:end:08-histological_verification.Rmd-->
